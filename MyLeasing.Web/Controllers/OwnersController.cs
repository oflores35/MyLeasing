...
namespace MyLeasing.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "no se puede borrar el usuario tiene propiedades");
                return RedirectToAction(nameof(Index));
            }
       ...
       [HttpPost]
        public async Task<IActionResult> AddContract(ContractViewModel model)
        {
            if (ModelState.IsValid)
            {
                var contract = await _comverterHelper.ToContractAsync(model, true);
        ...
        public async Task<IActionResult> EditContract(int? id)
        {
            ...
            return View(_comverterHelper.ToContractViewModel(contract));
        }
        ...
        public async Task<IActionResult> EditContract(ContractViewModel model)
        {
            if (ModelState.IsValid)
            {
                var contract = await _comverterHelper.ToContractAsync(model, false);
        ...
        public async Task<IActionResult> DeleteProperty(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "La propiedad tiene contratos y no puede ser borrado");
